...
public class OtherFakeDataTaskDao implements TaskDao {
    private static Map<Integer, Task> tasks;

    static {
        tasks = new HashMap<Integer, Task>();
        tasks.put(1, new Task(1, "Buy lettuce", false));
        tasks.put(2, new Task(2, "Walk the rabbit", true));
        tasks.put(3, new Task(3, "Water the plant", false));
    }
